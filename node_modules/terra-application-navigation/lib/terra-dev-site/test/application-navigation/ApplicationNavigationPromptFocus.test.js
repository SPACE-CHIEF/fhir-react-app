...
var ApplicationNavigationPromptFocus = function ApplicationNavigationPromptFocus() {
  ...
  function ManageItemSelection(key) {
    ...
    var Accept = confirm("Do you wish to Navigate to ".concat(key));
...
var _default = ApplicationNavigationPromptFocus;
