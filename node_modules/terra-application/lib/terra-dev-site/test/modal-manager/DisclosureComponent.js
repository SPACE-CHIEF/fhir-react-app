...
var _NotificationBannerExample = _interopRequireDefault(require("../notification-banner/NotificationBannerExample"));

var _applicationStatusOverlay = _interopRequireDefault(require("../../../application-status-overlay"));
...
var DisclosureComponent = /*#__PURE__*/function (_React$Component) {
  ...
  (0, _createClass2.default)(DisclosureComponent, [{
    ...
    value: function componentDidMount() {
      ...
      setTimeout(function () {
        _this2.setState({
          disclosureCount: (0, _disclosureManager.getActiveDisclosureCount)()
        });
      });

      if (this.props.useCustomDismissCheck && this.props.disclosureManager.registerDismissCheck) {
        this.props.disclosureManager.registerDismissCheck(function () {
          return Promise.reject();
        }).then(function () {
          /* registerDismissCheck should return a Promise, so this should not throw an exception */
        });
      }
    }
  }, {
    ...
    value: function generateOptions(values, name) {
      ...
      return values.map(function (currentValue, index) {
        ...
        return /*#__PURE__*/_react.default.createElement("option", {
          id: "".concat(name, "-").concat(currentValue, "-").concat(_this3.props.nestedIndex),
          key: keyValue,
          value: currentValue
        }, currentValue);
      });
    ...
    value: function disclose(size, dimensions) {
      ...
      var _this$props = this.props,
          ...
          useCustomDismissCheck = _this$props.useCustomDismissCheck;
      var newIndex = nestedIndex + 1;
      return function () {
        _this4.props.disclosureManager.disclose({
    ...
    value: function render() {
      ...
      var _this$props2 = this.props,
          ...
          nestedIndex = _this$props2.nestedIndex,
      ...
      var _this$state = this.state,
          ...
          hasStatusOverlay = _this$state.hasStatusOverlay,
          disclosureCount = _this$state.disclosureCount;
      ...
      }, renderHeaderAdapter && nestedIndex > 0 ? /*#__PURE__*/_react.default.createElement(_disclosureManager.DisclosureManagerHeaderAdapter, {
      ...
      }, "Disclose Fullscreen"), /*#__PURE__*/_react.default.createElement("button", {
        type: "button",
      ...
      }, "Pending Action"), /*#__PURE__*/_react.default.createElement("button", {
        type: "button",
      ...
      }, "Loading Overlay"), /*#__PURE__*/_react.default.createElement("button", {
        type: "button",
        className: "status-view-toggle",
        onClick: function onClick() {
          _this5.setState(function (state) {
            return {
              hasStatusOverlay: !state.hasStatusOverlay
            };
          });
        }
      }, "Status View"), /*#__PURE__*/_react.default.createElement("button", {
        type: "button",
      ...
      }, "Minimize") : null, /*#__PURE__*/_react.default.createElement("button", {
        type: "button",
        className: "global-close-disclosure",
        onClick: _disclosureManager.closeMostRecentDisclosure
      }, "Global Close (".concat(disclosureCount, ")")), hasPendingAction && /*#__PURE__*/_react.default.createElement(_navigationPrompt.default, {
        description: "Test Action"
      }), hasLoadingOverlay && /*#__PURE__*/_react.default.createElement(_applicationLoadingOverlay.default, {
        isOpen: true,
        backgroundStyle: "light"
      }), /*#__PURE__*/_react.default.createElement(_NotificationBannerExample.default, {
        isInitiallyClosed: true,
        id: identifier
      }), hasStatusOverlay && /*#__PURE__*/_react.default.createElement(_applicationStatusOverlay.default, {
        message: "Test status view",
        variant: "no-data"
      }));
    }
  }]);
...
DisclosureComponent.propTypes = {
  ...
  useCustomDismissCheck: _propTypes.default.bool
};
