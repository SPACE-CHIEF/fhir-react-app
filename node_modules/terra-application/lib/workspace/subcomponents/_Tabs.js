...
var Tabs = /*#__PURE__*/function (_React$Component) {
  ...
  (0, _createClass2.default)(Tabs, [{
    ...
    value: function handleResize() {
      ...
      var moreMarginLeft = parseInt(moreStyle.getPropertyValue('margin-left'), 0);
      var moreMarginRight = parseInt(moreStyle.getPropertyValue('margin-right'), 0);
      var moreButtonWidth = this.moreButtonRef.current.getBoundingClientRect().width + moreMarginLeft + moreMarginRight;
      var availableWidth = width - moreButtonWidth; // Calculate hidden index
    ...
    value: function positionDropDown() {
      ...
      var workspaceRect = this.containerRef.current.parentNode.parentNode.getBoundingClientRect(); // calculate Offset
