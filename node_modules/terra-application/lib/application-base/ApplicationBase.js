...
var browserLocale = (0, _getBrowserLocale.default)(); // We only need to retrieve the root theme and root theme name once for the life of the application.
...
var ApplicationBase = function ApplicationBase(_ref) {
  ...
  var _useTestOverrides = (0, _useTestOverrides2.default)(),
      localeOverride = _useTestOverrides.localeOverride; // Allows us to test deployed applications in different locales.
