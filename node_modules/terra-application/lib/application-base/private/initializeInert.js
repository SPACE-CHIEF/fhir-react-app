...
require("./inertStyles.scss");

require("mutationobserver-shim");

require("../../utils/polyfills/_contains-polyfill");

require("../../utils/polyfills/_matches-polyfill");
...
function initializeInert() {
  ...
  var inertStyleLink = document.createElement('link');
  inertStyleLink.id = 'inert-style';
  var styleLinkParent = document.head || document.body;
  styleLinkParent.appendChild(inertStyleLink); // eslint-disable-next-line global-require
