...
var ApplicationErrorBoundary = /*#__PURE__*/function (_React$Component) {
  (0, _inherits2.default)(ApplicationErrorBoundary, _React$Component);

  var _super = _createSuper(ApplicationErrorBoundary);
  ...
  function ApplicationErrorBoundary(props) {
    ...
    _this.errorRef = /*#__PURE__*/_react.default.createRef();
    _this.state = {
      error: undefined
    };
    return _this;
  ...
  (0, _createClass2.default)(ApplicationErrorBoundary, [{
    ...
    value: function render() {
      ...
      if (activeError) {
        var errorDetails = activeError.message.toString();
        var errorText = intl.formatMessage({
          id: 'terraApplication.errorBoundary.defaultErrorMessage'
        }, {
          errorDetails: errorDetails
        });
        return /*#__PURE__*/_react.default.createElement(_terraStatusView.default, {
          variant: "error",
          message: errorText,
          role: "alert"
        });
...
var _default = (0, _reactIntl.injectIntl)(ApplicationErrorBoundary);
