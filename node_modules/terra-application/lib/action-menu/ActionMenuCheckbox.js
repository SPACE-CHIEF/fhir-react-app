...
var _ActionMenuCheckboxModule = _interopRequireDefault(require("./ActionMenuCheckbox.module.scss"));

var cx = _bind.default.bind(_ActionMenuCheckboxModule.default);
...
var ActionMenuCheckbox = function ActionMenuCheckbox(_ref) {
  ...
  return /*#__PURE__*/_react.default.createElement("li", (0, _extends2.default)({}, attrs, {
    className: cx('action-menu-checkbox', {
...
var _default = ActionMenuCheckbox;
