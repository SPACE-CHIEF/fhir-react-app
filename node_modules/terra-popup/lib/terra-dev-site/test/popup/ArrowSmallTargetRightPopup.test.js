...
var _ArrowSmallTargetRightPopupTestModule = _interopRequireDefault(require("./ArrowSmallTargetRightPopup.test.module.scss"));
...
var cx = _bind.default.bind(_ArrowSmallTargetRightPopupTestModule.default); // This tests verifies the PopupUtils.getContentOffset methed when (targetNode.clientWidth < segment) & attachment is right


var OffsetPopup = /*#__PURE__*/function (_React$Component) {
  (0, _inherits2.default)(OffsetPopup, _React$Component);

  var _super = _createSuper(OffsetPopup);
  ...
  (0, _createClass2.default)(OffsetPopup, [{
    ...
    value: function render() {
      ...
      }, "This popup was adjusted because the target was smaller than the arrow position allowed.")), /*#__PURE__*/_react.default.createElement("button", {
        type: "button",
        id: "offset-button",
