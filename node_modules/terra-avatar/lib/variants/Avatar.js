  ...
  _createClass(Avatar, [{
    ...
    value: function render() {
      ...
      var avatarParams = {
        ...
        variant: _AvatarUtils.AVATAR_VARIANTS.USER,
        handleFallback: this.handleFallback,
        initials: initials.length > 2 ? initials.slice(0, 2) : initials
      };

      if (image) {
        avatarContent = (0, _AvatarUtils.generateImage)(avatarParams);
      } else {
        avatarContent = (0, _AvatarUtils.generateInitials)(avatarParams);
      }
      ...
      var avatarClassNames = (0, _classnames.default)(cx('avatar', (0, _AvatarUtils.setColor)(alt, color, hashValue), {
...
Avatar.contextType = _terraThemeContext.default;
var _default = Avatar;
